        ...
        <div className="col-md-8 m-auto">
          ...
          <form onSubmit={this.onSubmit}>
            <div className="form-group">
              <input type="text" className={classnames('form-control form-control-lg', {'is-invalid':errors.eusername})}  placeholder="Email Address or UserName" name="eusername" value={this.state.eusername} onChange={this.onChange}/>{errors.eusername && (<div className="invalid-feedback">
              {errors.eusername}
              </div>)}
            </div>
            <div className="form-group">
